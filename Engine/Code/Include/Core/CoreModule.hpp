...
#define DISABLE_WARNINGS \
        ...
        DO_PRAGMA(clang diagnostic ignored "-Wnullability-extension") \
        DO_PRAGMA(clang diagnostic ignored "-Wunused-private-field") \
        DO_PRAGMA(clang diagnostic ignored "-Wunused-parameter") \
        DO_PRAGMA(clang diagnostic ignored "-Wunused-variable") \
        DO_PRAGMA(clang diagnostic ignored "-Wmissing-field-initializers") \
