...
public:
	...
	KENGINE_API virtual void CopyImageToImage(Core::RefCountPtr<Image> srcImage, Core::RefCountPtr<Image> dstImage, bool returnSrcImageToInitialStage = true, bool returnDstImageToInitialStage = true) = 0;
